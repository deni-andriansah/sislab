                ...
                <div class="card-body">
                    <form action="{{ route('pm_barang.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="code_peminjaman" name="code_peminjaman" value="{{ old('code_peminjaman', 'PM-' . date('Ymd') . '-' . rand(1000,9999)) }}" readonly class="form-control bg-light" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nama_peminjam" class="form-control bg-light" readonly required value="{{ old('nama_peminjam') }}">
                            @error('id_anggota')
